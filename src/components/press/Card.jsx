...
function Card({ newsPaper, image, title, link }) {
  return (
    ...
    >
      ...
      <Link
        href={link}
        className="text-center bg-[var(--primary-color)] py-[12px] xl:py-[14px] 2xl:py-[16px] px-[24px] xl:px-[28px] 2xl:px-[36px] xl:text-lg 2xl:text-xl w-full border border-[#B5BF9E] rounded-[16px] hover:opacity-90 hover:scale-105 transition-all duration-300"
      >
        View Article
      </Link>
    </motion.div>
