    ...
    <section className="w-full bg-[#F4F4F4] px-5 py-16 lg:px-11 lg:py-24">
      <div className="mx-auto w-full">
        ...
        <article className="grid grid-cols-1 gap-5 lg:grid-cols-[540px_1fr] lg:gap-6">
          <Link href={featureLink} className="block">
            <img
              src={featureImage}
              alt="Press feature"
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-3 flex items-start justify-between gap-4">
              <Link
                href={featureLink}
                className="max-w-[920px] text-[24px] uppercase leading-[0.95] tracking-[-0.02em] text-[#1D1D1D] hover:opacity-80 lg:text-[32px]"
              >
                {featureTitle}
              </Link>
            ...
            {featureSourceLogo ? (
              <img
                src={featureSourceLogo}
                alt={featureSource || "Publication logo"}
                className="mt-auto h-8 w-auto object-contain lg:h-10"
              />
            ) : (
