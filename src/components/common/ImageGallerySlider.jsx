      ...
      <div className="relative w-full h-[100vw] md:h-[42vw]">
        ...
        {items.length > 1 && (
          <>
            ...
            >
              <div
                className="w-[44px] h-[72px] md:w-[54px] md:h-[86px] rounded-[3px] grid place-items-center shadow-md"
                style={{ backgroundColor: "rgba(250, 250, 250, 0.33)" }}
              >
                <img src="/carousel-left-arrow.png.svg" alt="prev" className="w-8 md:w-12 select-none" draggable={false} />
              </div>
            </button>
            <button
              onClick={handleNext}
            ...
            >
              <div
                ...
                style={{ backgroundColor: "rgba(250, 250, 250, 0.33)" }}
              >
                <img src="/carousel-right-arrow.svg" alt="next" className="w-8 md:w-12 select-none" draggable={false} />
              </div>
            </button>
          </>
        )}
