...
const PastSpeakers = ({ speakers = [] }) => {
  ...
  const defaultSpeakersRow1 = [
    { id: 1, image: '/homepage/past_speakers/1.png', name: 'Elizabeth Olson', description: 'Elizabeth Olson is Head of Marketing at Magic Eden Wallet and was previously Head of Growth at Xverse.', twitter: 'https://x.com/elizabethols0n?lang=en' },
    { id: 2, image: '/homepage/past_speakers/2.png', name: 'Pete Rizzo', description: "Pete Rizzo conducts archival research on Bitcoin's history, working to identify the people and events that most impacted its development", twitter: 'https://x.com/pete_rizzo_?lang=en' },
    { id: 3, image: '/homepage/past_speakers/3.png', name: 'Avihu levy', description: 'CPO at StarkWare', twitter: 'https://x.com/avihu28' },
    { id: 4, image: '/homepage/past_speakers/4.png', name: 'Dan held', description: 'Dan is investing in Bitcoin DeFi as a GP at Asymmetric, and a marketing advisor at Taproot Wizards, Mezo, Starkware others.', twitter: 'https://x.com/danheld?lang=en' },
    { id: 5, image: '/homepage/past_speakers/5.png', name: 'Charlie Spears', description: 'Charlie Spears is Co-Founder of Blockspace Media, Strategy at Nakamotor Partners, a Bitcoin mining company building the future of energy.', twitter: 'https://x.com/cbspears' },
    { id: 6, image: '/homepage/past_speakers/6.png', name: 'Trevor Owens', description: 'Trevor Owens is the managing partner of Bitcoin Frontier Fund and co-founder and CEO of Ninjalerts. He graduated from the Stern School of Business at New York University.', twitter: 'https://x.com/TO' },
  ];
  ...
  const handleScrollLeft = () => {
    if (row1Ref.current && row2Ref.current) {
      const scrollAmount = window.innerWidth >= 1536 ? 564 : 331; // 2xl: card width (532) + gap (32), lg: card width (299) + gap (32)
  ...
  useEffect(() => {
    ...
    const scrollSpeed = window.innerWidth >= 1536 ? 1.0 : 0.5; // 2xl: faster speed, lg: normal speed
    let isHovered = false;
    ...
    const autoScrollRow1 = () => {
      ...
      if (!isPausedRow1Ref.current && !isHovered) {
        ...
        const cardWidth = window.innerWidth >= 1536 ? 532 + 32 : 299 + 32; // 2xl: card width (532) + gap (32), lg: card width (299) + gap (32)
  ...
  return (
    <div className="py-[60px] lg:py-[80px] xl:py-[100px] 2xl:py-[180px] max-w-none w-full mx-auto bg-[#000000] overflow-hidden">
      <div className="px-[20px] lg:px-[60px] xl:px-[140px] 2xl:px-[250px] title-spacing relative flex flex-row items-center justify-between">
        ...
        <div className="hidden lg:flex gap-4">
          ...
          >
            <motion.img
              src="/left.jpg"
              className="cursor-pointer w-[36px] h-[36px] lg:w-[40px] lg:h-[40px] xl:w-[48px] xl:h-[48px] 2xl:h-[70px] 2xl:w-[70px] rounded-[5px] lg:rounded-[8px] xl:rounded-[10px] 2xl:rounded-[15px]"
              whileTap={{ scale: 0.9 }}
            />
          </button>
          <button
      ...
      <div className="lg:hidden relative">
        ...
        >
          {duplicatedSpeakers.map((speaker, index) => {
            ...
            return (
              <div key={cardId} className="flex-shrink-0 w-[280px] h-[350px] 2xl:w-[532px] 2xl:h-[640px] perspective-[2000px]">
                <div
        ...
        <div className="space-y-8 overflow-x-hidden">
          ...
          <div ref={row1Ref} className="flex gap-8 overflow-x-hidden">
            {row1.map((speaker, index) => (
              <div key={`row1-${speaker.id}-${index}`} className="group flex-shrink-0 w-[240px] h-[288px] xl:w-[299px] xl:h-[359px] 2xl:w-[532px] 2xl:h-[640px] perspective-[2000px]">
                <div className="relative w-full h-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180">
                  ...
                  {/* Back of card */}
                  <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-[#7FFFD4] rounded-[15px] p-6 2xl:p-10 flex flex-col justify-start">
                    <h3 className="text-black text-[1.2rem] xl:text-[1.4rem] 2xl:text-[2.4rem] font-extrabold uppercase mb-4 leading-tight">
                      {speaker.name || 'Speaker Name'}
                    </h3>
                    <p className="text-black text-[0.8rem] xl:text-[0.9rem] 2xl:text-[1.6rem] font-semibold leading-[1.4] mb-4 flex-grow overflow-y-auto">
                      {speaker.description || 'Speaker description goes here'}
                    </p>
                    {speaker.twitter && (
                      <div className="flex items-center gap-3 mt-auto pt-4">
                        ...
                        >
                          <img
                            src="https://upload.wikimedia.org/wikipedia/commons/5/57/X_logo_2023_%28white%29.png"
                            alt="X (Twitter) Logo"
                            className="w-4 h-4 xl:w-5 xl:h-5 2xl:w-7 2xl:h-7 invert"
                          />
                          <h3 className="text-[0.9rem] xl:text-[1rem] 2xl:text-[1.8rem] font-bold">
                            {speaker.name || 'Speaker Name'}
                          </h3>
                        </a>
                      </div>
          ...
          <div ref={row2Ref} className="flex gap-8 overflow-x-hidden">
            {row2.map((speaker, index) => (
              <div key={`row2-${speaker.id}-${index}`} className="group flex-shrink-0 w-[240px] h-[288px] xl:w-[299px] xl:h-[359px] 2xl:w-[532px] 2xl:h-[640px] perspective-[2000px]">
                <div className="relative w-full h-full transition-transform duration-500 transform-style-3d group-hover:rotate-y-180">
                  {/* Front of card */}
                  <div className="absolute w-full h-full backface-hidden">
                    <img
