    ...
    >
      <div className="w-full bg-[#000000] pt-8 lg:py-8 sm:p-0">
        ...
        <div className="hidden lg:flex w-full max-w-none gap-[70px] xl:gap-[100px] 2xl:gap-[150px] mx-auto">
          ...
          <div className="w-3/7 pr-8 p-8 2xl:p-[56px] bg-[#FFF7E6] lg:rounded-[8px] rounded-[12px] 2xl:rounded-[15px]">
            <div className="w-full">
              ...
              {/* Message display */}
              {message && (
                <div className={`mt-4 text-sm ${message.includes('successfully')
                  ? 'text-green-600'
                  : 'text-red-600'
                  }`}>
                  {message}
        ...
        <div className="lg:hidden w-full mx-auto">
          <div className="bg-white p-[27px] rounded-lg shadow-sm mb-8">
            <div className="w-full">
              <div className="text-[24px] font-bold leading-10 text-[#141414] text-left">
                Subscribe
                <br />
                To Our Newsletter
              </div>
              <div className="flex justify-center items-center px-[14px] py-[10px] mt-5 w-full text-base rounded-full bg-[#000000]">
                <div className="flex gap-3 justify-between items-center w-full">
                  <input
                    type="email"
                    placeholder="Enter your email address"
                    ...
                    onChange={(e) => setEmail(e.target.value)}
                    onKeyPress={(e) => e.key === 'Enter' && handleSubmit()}
                    className="flex-1 min-w-0 2xl:pt-[12px] placeholder:text-[13px] lg:placeholder:text-[20px] 2xl:placeholder:text-[35px] font-medium text-white bg-transparent border-none outline-none focus:outline-none placeholder:text-[#fff]"
                    disabled={isLoading}
                  />
                  <button
                    onClick={handleSubmit}
                    disabled={isLoading}
                    className={`flex-shrink-0 px-6 2xl:px-8 py-3 2xl:py-5 text-[14px] 2xl:text-[28px] leading-none text-black whitespace-nowrap bg-[#92FF68] rounded-full border border-black border-solid transition-colors ${isLoading
                      ? 'opacity-50 cursor-not-allowed'
                      : 'hover:bg-[#92FF68]'
                      }`}
                  >
              ...
              <div className="space-y-6 flex-1">
                ...
                <div>
                  <div className="flex items-center">
                    <span className="font-bold text-[16px] text-[#141414]">
                      BTC Vegas
                    </span>
                  </div>
                  <div className="text-[12px] text-[#666] mt-1">Plan + Go</div>
                </div>
      ...
      {/* Social icons column */}
      <div className="lg:hidden 2xl:px-10">
        <div className="flex items-center justify-center px-4 space-y-4 flex-row gap-[6px]">
          <img
            src="/footer/x_Icon.svg"
            alt="YouTube"
            className="w-12 2xl:w-20 h-12 2xl:h-20 mb-0 cursor-pointer"
            onClick={() => window.open("https://x.com/nolchashows", "_blank")}
          />
          <img
            src="/footer/linkedin.svg"
      ...
      <div className="mt-8 w-full text-xl leading-none text-neutral-900">
        <div className="lg:pt-8 w-full">
          <div className="flex flex-wrap gap-10 justify-between items-center lg:items-start w-full">
            <div className="text-center md:text-left">
              <img
                src="/footer/logo.png"
                className="object-contain max-w-full aspect-[3.57] w-[135px] lg:w-[168px] 2xl:w-[200px] mx-auto md:mx-0"
                alt="Logo"
              />
