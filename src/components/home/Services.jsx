          ...
          <>
            ...
            <div className="flex items-start gap-6 mb-8">
              ...
              <div className="flex-1">
                <h3 className="text-2xl lg:text-[26px] font-bold leading-[31px] -tracking-[0.78px] text-black">
          ...
          <>
            ...
            <div className="flex flex-col lg:flex-row gap-5 mb-2 lg:mb-8 flex-grow">
              <div className="lg:w-[245px] flex-shrink-0">
                <h3 className="text-2xl lg:text-[26px] font-bold leading-[31px] -tracking-[0.78px] text-black mb-4 lg:mb-6">
