...
export default function LogoSlider({ logoSliderData, loading }) {
  ...
  if (loading) {
    return (
      <div className="w-full bg-white h-[60px] md:h-[116px] 2xl:h-[130px] flex items-center justify-center">
    ...
    <>
      ...
      <div className="w-full bg-white overflow-hidden">
        <div className="flex h-[60px] md:h-[116px] 2xl:h-[130px] items-center">
          ...
          <div className="flex-shrink-0 bg-white h-full flex items-center justify-center px-8 min-w-[180px] md:min-w-[350px] 2xl:min-w-[400px]">
            ...
            <div className="absolute inset-0 flex items-center">
              ...
              >
                {duplicatedLogos.map((logo, index) => (
                  <div
                    key={`${logo.name}-${index}`}
                    className="flex-shrink-0 flex border border-white bg-black items-center justify-center w-[180px] md:w-[350px] h-[60px] md:h-[116px] 2xl:min-h-[130px]"
                  >
                    {logo.url ? (
                      <img
                        src={logo.url}
