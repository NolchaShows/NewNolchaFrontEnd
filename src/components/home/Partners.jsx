...
const Partners = ({ title, description, partners, bg, logo }) => {
  ...
  const getResponsiveClasses = () => {
    if (windowWidth >= 1800) {
      return {
        columnGap: "gap-12", // Gap between columns
        cardGap: "gap-2", // Gap between cards within columns
      ...
      return {
        columnGap: "gap-1", // Gap between columns
        cardGap: "gap-[6px]", // Gap between cards within columns
        containerPadding: "px-[177px] 2xl:px-32 xl:px-16",
        maxColumnWidth: "max-w-[145px]",
        minHeight: "min-h-[400px]",
      };
      ...
      return {
        columnGap: "gap-1.5 sm:gap-2",
        cardGap: "gap-1.5 sm:gap-2",
    ...
    >
      <div className="max-w-[1076px] mx-auto flex flex-col items-center gap-[50px] xl:gap-10 lg:gap-8">
        ...
        <div className="flex flex-col items-center gap-2.5">
          {title ? (
            <h2
              className="text-black text-center font-bold text-[52px] 2xl:text-[52px] xl:text-[42px] lg:text-[36px] md:text-[32px] sm:text-[28px] leading-[120%] -tracking-[1.56px] xl:-tracking-[1.26px] lg:-tracking-[1.08px] md:-tracking-[0.96px] sm:-tracking-[0.84px] capitalize"
          ...
          {description && (
            <p
              className="text-black text-center font-normal text-xl 2xl:text-[24px] xl:text-[20px] lg:text-base md:text-base sm:text-sm leading-[140%] -tracking-[0.6px] 2xl:-tracking-[0.72px] xl:-tracking-[0.54px] lg:-tracking-[0.48px]"
              style={{ fontFamily: "'Neue Haas Grotesk Text Pro', sans-serif" }}
            >
              {description}
            </p>
