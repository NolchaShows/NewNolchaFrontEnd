        ...
        <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50 p-4">
            <div className="bg-[#EBE2D7] rounded-2xl w-full max-w-none max-h-[90vh] m-10 relative shadow-lg overflow-hidden flex flex-col">
                <button
                    ...
                    className="absolute right-7 top-3 text-gray-600 hover:text-gray-800 text-xl z-10 bg-white bg-opacity-80 cursor-pointer hover:bg-opacity-100 rounded-lg w-8 h-8 2xl:w-12 2xl:h-12 flex items-center justify-center transition-all duration-200"
