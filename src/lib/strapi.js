...
/**
 * Fetch all charity pages for navigation/dropdowns
 * @returns {Promise<Array>} - Array of charity pages
 */
...
export async function getWhiteLabelPageData() {
  try {
    ...
    const populateQuery = [
      ...
      "populate[6]=shared_partner_section",
      "populate[7]=shared_partner_section.partners",
