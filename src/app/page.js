...
const inscribingMiamiData = {
  ...
  logoSlider: {
    title: "AS SEEN IN",
    logos: [
      { name: "AdAge", url: "/inscribing_miami/logo_slider/slider1.png" },
      { name: "VOGUE", url: "/inscribing_miami/logo_slider/slider2.png" },
      { name: "Forbes", url: "/inscribing_miami/logo_slider/slider3.png" },
      { name: "Cointelegraph", url: "/inscribing_miami/logo_slider/slider4.jpg" },
  ...
  whatToExpect: {
    ...
    quoteBox: {
      logo: "/inscribing_miami/Forbes.png",
  ...
  communityTrust: {
    ...
    formSection: {
      backgroundImage: "/inscribing_miami/background2.jpg",
