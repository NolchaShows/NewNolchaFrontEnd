  ...
  const upcomingListEvents = [
    {
      ...
      location: "Join us for the Consensus 2026 Official Opening Night Party at The Trilogy, a multi-experience destination spanning three distinct venues on the 26th floor, overlooking the Hong Kong skyline.",
      pastEventsLocation: "Houston Texas Usa",
      letsTalkLocation: "Location:",
      whiteLabelLocation: "Location:",
      // Modal-specific data
      venue: "Join us for the Consensus 2026 Official Opening Night Party at The Trilogy, a multi-experience destination spanning three distinct venues on the 26th floor, overlooking the Hong Kong skyline.",
      whatToExpect: "Get your brand front and center at Consensus 2026's Official Opening Night for an unforgettable fusion of technology, innovation, and entertainment.",
      ...
      mainImage: "https://images.squarespace-cdn.com/content/6543e07afbb3360bba3e0b3b/e5191464-6cdc-4f1b-9c00-9b8f9726dd08/049_Photagonist.ca.webp?content-type=image%2Fwebp",
      galleryImages: [
    ...
    { 
      ...
      whatToExpect: "Join the world's largest Bitcoin conference featuring top speakers, networking opportunities, and exclusive events.",
      rsvpLink: "#",
      logo: "",
    ...
    { 
      ...
      whatToExpect: "Experience Consensus Miami with cutting-edge blockchain technology, networking events, and exclusive after-parties.",
      rsvpLink: "#",
      logo: "",
    ...
    { 
      ...
      whatToExpect: "A summer-long series of events celebrating multichain innovation, featuring workshops, conferences, and networking opportunities.",
      rsvpLink: "#",
      logo: "",
    ...
    { 
      ...
      whatToExpect: "Join us for exclusive fashion week events, runway shows, and networking with industry leaders and influencers.",
      rsvpLink: "#",
      logo: "",
    ...
    { 
      ...
      whatToExpect: "Asia's premier crypto event featuring the brightest minds in Web3, blockchain, and cryptocurrency.",
      rsvpLink: "#",
      logo: "",
    ...
    { 
      ...
      whatToExpect: "Experience the intersection of art and technology at Art Basel Miami with exclusive events, gallery openings, and VIP experiences.",
      rsvpLink: "#",
      logo: "",
